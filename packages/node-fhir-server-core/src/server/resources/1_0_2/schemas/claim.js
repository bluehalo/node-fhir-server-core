  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'coverage', {
      ...
      set: (value) => {
        ...
        this.__data.coverage = Array.isArray(value)
          ? value.map((v) => new ClaimCoverage(v))
          : [new ClaimCoverage(value)];
      },
    });
    ...
    Object.defineProperty(this, 'interventionException', {
      ...
      set: (value) => {
        ...
        let Coding = require('./coding.js');
        this.__data.interventionException = Array.isArray(value)
          ? value.map((v) => new Coding(v))
          : [new Coding(value)];
      },
    });
    ...
    Object.defineProperty(this, 'additionalMaterials', {
      ...
      set: (value) => {
        ...
        let Coding = require('./coding.js');
        this.__data.additionalMaterials = Array.isArray(value)
          ? value.map((v) => new Coding(v))
          : [new Coding(value)];
      },
    });
  ...
  toJSON() {
    return {
      ...
      interventionException:
        this.interventionException && this.interventionException.map((v) => v.toJSON()),
      item: this.item && this.item.map((v) => v.toJSON()),
      additionalMaterials:
        this.additionalMaterials && this.additionalMaterials.map((v) => v.toJSON()),
