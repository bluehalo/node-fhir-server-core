  ...
  constructor(opts) {
    ...
    Object.defineProperty(this, 'consentingParty', {
      ...
      set: (value) => {
        ...
        let Reference = require('./reference.js');
        this.__data.consentingParty = Array.isArray(value)
    ...
    Object.defineProperty(this, 'actor', {
      ...
      set: (value) => {
        ...
        this.__data.actor = Array.isArray(value)
          ? value.map((v) => new ConsentActor(v))
          : [new ConsentActor(value)];
      },
    });
    ...
    Object.defineProperty(this, 'data', {
      ...
      set: (value) => {
        ...
        this.__data.data = Array.isArray(value)
          ? value.map((v) => new ConsentData(v))
          : [new ConsentData(value)];
      },
    });
    ...
    Object.defineProperty(this, 'except', {
      ...
      set: (value) => {
        ...
        this.__data.except = Array.isArray(value)
          ? value.map((v) => new ConsentExcept(v))
          : [new ConsentExcept(value)];
      },
    });
