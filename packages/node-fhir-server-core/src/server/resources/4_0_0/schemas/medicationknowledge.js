  ...
  toJSON() {
    return {
      ...
      associatedMedication:
        this.associatedMedication && this.associatedMedication.map((v) => v.toJSON()),
      ...
      administrationGuidelines:
        this.administrationGuidelines && this.administrationGuidelines.map((v) => v.toJSON()),
      medicineClassification:
        this.medicineClassification && this.medicineClassification.map((v) => v.toJSON()),
