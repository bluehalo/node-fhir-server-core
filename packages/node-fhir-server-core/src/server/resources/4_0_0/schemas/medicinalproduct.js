  ...
  toJSON() {
    return {
      ...
      additionalMonitoringIndicator:
        this.additionalMonitoringIndicator && this.additionalMonitoringIndicator.toJSON(),
      ...
      productClassification:
        this.productClassification && this.productClassification.map((v) => v.toJSON()),
      marketingStatus: this.marketingStatus && this.marketingStatus.map((v) => v.toJSON()),
      pharmaceuticalProduct:
        this.pharmaceuticalProduct && this.pharmaceuticalProduct.map((v) => v.toJSON()),
      packagedMedicinalProduct:
        this.packagedMedicinalProduct && this.packagedMedicinalProduct.map((v) => v.toJSON()),
