  ...
  toJSON() {
    return {
      ...
      definitionCodeableConcept:
        this.definitionCodeableConcept && this.definitionCodeableConcept.toJSON(),
      ...
      definitionDataRequirement:
        this.definitionDataRequirement && this.definitionDataRequirement.toJSON(),
      ...
      _studyEffectiveDescription:
        this._studyEffectiveDescription && this._studyEffectiveDescription.toJSON(),
      ...
      studyEffectiveTimeFromStart:
        this.studyEffectiveTimeFromStart && this.studyEffectiveTimeFromStart.toJSON(),
      _studyEffectiveGroupMeasure:
        this._studyEffectiveGroupMeasure && this._studyEffectiveGroupMeasure.toJSON(),
      ...
      _participantEffectiveDateTime:
        this._participantEffectiveDateTime && this._participantEffectiveDateTime.toJSON(),
      participantEffectiveDateTime: this.participantEffectiveDateTime,
      participantEffectivePeriod:
        this.participantEffectivePeriod && this.participantEffectivePeriod.toJSON(),
      participantEffectiveDuration:
        this.participantEffectiveDuration && this.participantEffectiveDuration.toJSON(),
      participantEffectiveTiming:
        this.participantEffectiveTiming && this.participantEffectiveTiming.toJSON(),
