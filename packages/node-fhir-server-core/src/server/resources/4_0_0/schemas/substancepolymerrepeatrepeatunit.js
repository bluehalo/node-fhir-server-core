  ...
  toJSON() {
    return {
      ...
      orientationOfPolymerisation:
        this.orientationOfPolymerisation && this.orientationOfPolymerisation.toJSON(),
      _repeatUnit: this._repeatUnit && this._repeatUnit.toJSON(),
      repeatUnit: this.repeatUnit,
      amount: this.amount && this.amount.toJSON(),
      degreeOfPolymerisation:
        this.degreeOfPolymerisation && this.degreeOfPolymerisation.map((v) => v.toJSON()),
      structuralRepresentation:
        this.structuralRepresentation && this.structuralRepresentation.map((v) => v.toJSON()),
    };
  }
};
