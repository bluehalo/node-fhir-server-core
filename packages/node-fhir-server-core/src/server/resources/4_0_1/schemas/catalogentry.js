  ...
  toJSON() {
    return {
      ...
      additionalIdentifier:
        this.additionalIdentifier && this.additionalIdentifier.map((v) => v.toJSON()),
      ...
      additionalCharacteristic:
        this.additionalCharacteristic && this.additionalCharacteristic.map((v) => v.toJSON()),
      additionalClassification:
        this.additionalClassification && this.additionalClassification.map((v) => v.toJSON()),
