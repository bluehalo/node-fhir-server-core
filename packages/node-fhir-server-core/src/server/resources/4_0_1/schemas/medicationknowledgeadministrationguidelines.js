    ...
    Object.defineProperty(this, 'patientCharacteristics', {
      ...
      set: (value) => {
        ...
        this.__data.patientCharacteristics = Array.isArray(value)
          ? value.map(
              (v) => new MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics(v)
            )
  ...
  toJSON() {
    return {
      ...
      indicationCodeableConcept:
        this.indicationCodeableConcept && this.indicationCodeableConcept.toJSON(),
      indicationReference: this.indicationReference && this.indicationReference.toJSON(),
      patientCharacteristics:
        this.patientCharacteristics && this.patientCharacteristics.map((v) => v.toJSON()),
    };
  }
};
