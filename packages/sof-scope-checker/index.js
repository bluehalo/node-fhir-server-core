...
module.exports = function SmartOnFHIRScopeChecker(name, action, scopes) {
  if (!Array.isArray(scopes)) {
    return {
      error: new FhirError('Invalid scopes. This parameter should be an array.', 'internal'),
      success: false,
    };
  }
  ...
  return {
    error: hasSufficientScope
      ? null
      : new FhirError('None of the provided scopes matched an allowed scope.', 'forbidden'),
