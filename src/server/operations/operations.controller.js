...
/**
 * @description Controller for all PATCH operations
 */
module.exports.operationsPatch = function operationsPatch({ profile, logger, funcName }) {
	let { serviceModule: service } = profile;

	return (req, res, next) => {
		let { base_version, resource_id } = req.sanitized_args;  //TODO account for this
		let resource_body = req.body;
		let args = { id: resource_id, base_version, resource: resource_body };
