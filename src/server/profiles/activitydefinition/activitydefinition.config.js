...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/activitydefinition/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/activitydefinition/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/activitydefinition/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('activitydefinition'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/activitydefinition/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('activitydefinition'),
