...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/AdverseEvent'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let AdverseEvent = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, AdverseEvent, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a adverseevent. If the adverseevent does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an adverseevent resource.
 */
