...
const resource_specific_args = require('./appointment.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/appointment/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/appointment/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/appointment/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('appointment'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/appointment/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('appointment'),
