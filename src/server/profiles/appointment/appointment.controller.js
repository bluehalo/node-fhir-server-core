...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Appointment'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Appointment, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a appointment. If the appointment does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an appointment resource.
 */
...
/**
* @description Controller for getting the history of a Appointment resource.
*/
...
/**
* @description Controller for getting the history of a Appointment resource by ID.
*/
