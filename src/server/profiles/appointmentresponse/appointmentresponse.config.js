...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/appointmentresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/appointmentresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/appointmentresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('appointmentresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/appointmentresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('appointmentresponse'),
