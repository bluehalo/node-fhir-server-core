...
module.exports.getAppointmentResponse = (req, logger, context) => new Promise((resolve, reject) => {
	let message = 'Calling mock service. Did you forget to implement \'getAppointmentResponse\'';
	logger.info(message);
	reject(new Error(message));
});

module.exports.getAppointmentResponseById = (req, logger, context) => new Promise((resolve, reject) => {
