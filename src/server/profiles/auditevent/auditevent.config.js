...
const resource_specific_args = require('./auditevent.arguments');
const controller = require('./auditevent.controller');

const validationUtils = require('../../utils/validation.utils');

let write_only_scopes = write_scopes('AuditEvent');
let read_only_scopes = read_scopes('AuditEvent');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/auditevent/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/auditevent/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('auditevent'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/auditevent/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('auditevent'),
