...
let getResourceConstructor = (base) => {
	let AuditEvent = require(resolveFromVersion(base, 'base/AuditEvent'));
	return AuditEvent;
};
...
/**
 * @description Controller for updating/creating a auditevent. If the auditevent does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an auditevent resource.
 */
