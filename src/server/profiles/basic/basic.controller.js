...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Basic'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let Basic = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Basic, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: basic};
...
/**
 * @description Controller for updating/creating a basic. If the basic does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an basic resource.
 */
...
/**
* @description Controller for getting the history of a Basic resource.
*/
...
/**
* @description Controller for getting the history of a Basic resource by ID.
*/
