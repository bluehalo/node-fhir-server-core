...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Binary'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let Binary = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Binary, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: binary};
...
/**
 * @description Controller for updating/creating a binary. If the binary does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an binary resource.
 */
