...
const resource_specific_args = require('./bodysite.arguments');
const controller = require('./bodysite.controller');

const validationUtils = require('../../utils/validation.utils');

let write_only_scopes = write_scopes('BodySite');
let read_only_scopes = read_scopes('BodySite');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/bodysite/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/bodysite/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('bodysite'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/bodysite/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('bodysite'),
