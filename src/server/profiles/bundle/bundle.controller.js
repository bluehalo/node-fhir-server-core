...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Bundle'));
};
...
/**
* @description Controller for getting the history of a Bundle resource.
*/
...
/**
* @description Controller for getting the history of a Bundle resource by ID.
*/
