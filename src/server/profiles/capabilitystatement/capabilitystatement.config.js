...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/capabilitystatement/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/capabilitystatement/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/capabilitystatement/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('capabilitystatement'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/capabilitystatement/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('capabilitystatement'),
