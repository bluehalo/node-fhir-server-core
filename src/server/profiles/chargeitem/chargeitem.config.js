...
const resource_specific_args = require('./chargeitem.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/chargeitem/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/chargeitem/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('chargeitem'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/chargeitem/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('chargeitem'),
