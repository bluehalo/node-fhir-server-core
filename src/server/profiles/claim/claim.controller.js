...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Claim'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Claim, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a claim. If the claim does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an claim resource.
 */
...
/**
* @description Controller for getting the history of a Claim resource.
*/
...
/**
* @description Controller for getting the history of a Claim resource by ID.
*/
