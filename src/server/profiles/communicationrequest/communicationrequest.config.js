...
const resource_specific_args = require('./communicationrequest.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/communicationrequest/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/communicationrequest/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/communicationrequest/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('communicationrequest'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/communicationrequest/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('communicationrequest'),
