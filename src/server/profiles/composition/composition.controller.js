...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Composition'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Composition, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a composition. If the composition does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an composition resource.
 */
...
/**
* @description Controller for getting the history of a Composition resource.
*/
...
/**
* @description Controller for getting the history of a Composition resource by ID.
*/
