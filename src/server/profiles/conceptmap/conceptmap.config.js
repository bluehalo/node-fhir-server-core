...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/conceptmap/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/conceptmap/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('conceptmap'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/conceptmap/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('conceptmap'),
