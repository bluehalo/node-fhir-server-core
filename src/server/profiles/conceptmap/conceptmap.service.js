...
module.exports.getConceptMap = (req, logger, context) => new Promise((resolve, reject) => {
	let message = 'Calling mock service. Did you forget to implement \'getConceptMap\'';
	logger.info(message);
	reject(new Error(message));
});

module.exports.getConceptMapById = (req, logger, context) => new Promise((resolve, reject) => {
