...
let getResourceConstructor = (base) => {
	let Consent = require(resolveFromVersion(base, 'base/Consent'));
	return Consent;
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Consent, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a consent. If the consent does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an consent resource.
 */
