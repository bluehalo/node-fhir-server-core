...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/DetectedIssue'));
};
...
/**
* @description Controller for getting the history of a DetectedIssue resource.
*/
...
/**
* @description Controller for getting the history of a DetectedIssue resource by ID.
*/
