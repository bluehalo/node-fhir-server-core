...
const resource_specific_args = require('./devicecomponent.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/devicecomponent/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/devicecomponent/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/devicecomponent/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('devicecomponent'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/devicecomponent/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('devicecomponent'),
