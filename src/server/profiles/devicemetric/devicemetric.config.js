...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/devicemetric/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('devicemetric'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/devicemetric/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('devicemetric'),
