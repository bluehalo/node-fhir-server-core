...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/deviceusestatement/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/deviceusestatement/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/deviceusestatement/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('deviceusestatement'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/deviceusestatement/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('deviceusestatement'),
