...
const resource_specific_args = require('./documentreference.arguments');
const controller = require('./documentreference.controller');

const validationUtils = require('../../utils/validation.utils');

let write_only_scopes = write_scopes('DocumentReference');
let read_only_scopes = read_scopes('DocumentReference');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/documentreference/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/documentreference/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/documentreference/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('documentreference'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/documentreference/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('documentreference'),
