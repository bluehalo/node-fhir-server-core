...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/eligibilityrequest/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/eligibilityrequest/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/eligibilityrequest/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('eligibilityrequest'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/eligibilityrequest/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('eligibilityrequest'),
