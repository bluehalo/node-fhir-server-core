...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/eligibilityresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/eligibilityresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/eligibilityresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('eligibilityresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/eligibilityresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('eligibilityresponse'),
