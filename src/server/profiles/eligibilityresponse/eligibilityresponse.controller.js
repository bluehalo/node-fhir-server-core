...
/**
* @description Controller for getting the history of a EligibilityResponse resource.
*/
...
/**
* @description Controller for getting the history of a EligibilityResponse resource by ID.
*/
