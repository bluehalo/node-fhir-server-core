...
/**
 * @description Controller for updating/creating a endpoint. If the endpoint does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an endpoint resource.
 */
