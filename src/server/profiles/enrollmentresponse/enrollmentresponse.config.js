...
const resource_specific_args = require('./enrollmentresponse.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/enrollmentresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/enrollmentresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/enrollmentresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('enrollmentresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/enrollmentresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('enrollmentresponse'),
