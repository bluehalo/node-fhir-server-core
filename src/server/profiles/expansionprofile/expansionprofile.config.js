...
const resource_specific_args = require('./expansionprofile.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/expansionprofile/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/expansionprofile/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/expansionprofile/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('expansionprofile'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/expansionprofile/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('expansionprofile'),
