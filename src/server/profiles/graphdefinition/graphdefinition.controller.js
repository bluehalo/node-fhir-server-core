...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/GraphDefinition'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let GraphDefinition = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, GraphDefinition, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: graphdefinition};
...
/**
 * @description Controller for updating/creating a graphdefinition. If the graphdefinition does not exist, it should be updated
 */
module.exports.update = function update({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		// Create a new graphdefinition resource and pass it to the service
		let graphdefinition = new GraphDefinition(resource_body);
		let args = {id, resource: graphdefinition};
		// Pass any new information to the underlying service
...
/**
 * @description Controller for deleting an graphdefinition resource.
 */
