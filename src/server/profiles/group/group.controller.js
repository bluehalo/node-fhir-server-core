...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Group'));
};
...
/**
 * @description Controller for updating/creating a group. If the group does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an group resource.
 */
...
/**
* @description Controller for getting the history of a Group resource.
*/
...
/**
* @description Controller for getting the history of a Group resource by ID.
*/
