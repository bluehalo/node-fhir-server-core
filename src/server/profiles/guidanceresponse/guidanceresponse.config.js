...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/guidanceresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/guidanceresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/guidanceresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('guidanceresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/guidanceresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('guidanceresponse'),
