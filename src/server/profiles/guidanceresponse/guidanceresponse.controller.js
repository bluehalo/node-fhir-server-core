...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/GuidanceResponse'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let GuidanceResponse = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, GuidanceResponse, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a guidanceresponse. If the guidanceresponse does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an guidanceresponse resource.
 */
