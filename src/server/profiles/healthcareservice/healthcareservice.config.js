...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/healthcareservice/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/healthcareservice/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/healthcareservice/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('healthcareservice'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/healthcareservice/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('healthcareservice'),
