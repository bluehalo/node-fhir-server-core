...
const resource_specific_args = require('./imagingstudy.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/imagingstudy/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/imagingstudy/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/imagingstudy/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('imagingstudy'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/imagingstudy/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('imagingstudy'),
