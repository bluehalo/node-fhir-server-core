...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/ImagingStudy'));
};
...
/**
 * @description Controller for updating/creating a imagingstudy. If the imagingstudy does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an imagingstudy resource.
 */
...
/**
* @description Controller for getting the history of a ImagingStudy resource.
*/
...
/**
* @description Controller for getting the history of a ImagingStudy resource by ID.
*/
