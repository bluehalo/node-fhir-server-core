...
const resource_specific_args = require('./immunizationrecommendation.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/immunizationrecommendation/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/immunizationrecommendation/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/immunizationrecommendation/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('immunizationrecommendation'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/immunizationrecommendation/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('immunizationrecommendation'),
