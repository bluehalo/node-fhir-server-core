...
/**
* @description Controller for getting the history of a ImmunizationRecommendation resource.
*/
...
/**
* @description Controller for getting the history of a ImmunizationRecommendation resource by ID.
*/
