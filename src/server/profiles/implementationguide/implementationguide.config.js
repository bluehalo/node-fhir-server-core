...
const resource_specific_args = require('./implementationguide.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/implementationguide/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/implementationguide/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/implementationguide/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('implementationguide'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/implementationguide/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('implementationguide'),
