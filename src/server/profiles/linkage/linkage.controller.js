...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Linkage'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Linkage, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a linkage. If the linkage does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an linkage resource.
 */
...
/**
* @description Controller for getting the history of a Linkage resource.
*/
...
/**
* @description Controller for getting the history of a Linkage resource by ID.
*/
