...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'uscore/Location'));
};
...
/**
* @description Controller for getting the history of a Location resource.
*/
...
/**
* @description Controller for getting the history of a Location resource by ID.
*/
