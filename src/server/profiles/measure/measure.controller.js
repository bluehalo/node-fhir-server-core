...
/**
* @description Controller for getting the history of a Measure resource.
*/
module.exports.history = function history ({ profile, logger }) {
	...
	return (req, res, next) => {
		...
		let Measure = require(resolveFromVersion(version, 'uscore/Measure'));
...
/**
* @description Controller for getting the history of a Measure resource by ID.
*/
