...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/measurereport/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('measurereport'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/measurereport/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('measurereport'),
