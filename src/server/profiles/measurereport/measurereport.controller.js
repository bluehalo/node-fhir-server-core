...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/MeasureReport'));
};
...
/**
 * @description Controller for updating/creating a measurereport. If the measurereport does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an measurereport resource.
 */
