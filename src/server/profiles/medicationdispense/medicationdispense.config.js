...
const resource_specific_args = require('./medicationdispense.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/medicationdispense/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/medicationdispense/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/medicationdispense/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('medicationdispense'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/medicationdispense/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('medicationdispense'),
