...
const resource_specific_args = require('./medicationrequest.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/medicationrequest/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/medicationrequest/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/medicationrequest/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('medicationrequest'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/medicationrequest/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('medicationrequest'),
