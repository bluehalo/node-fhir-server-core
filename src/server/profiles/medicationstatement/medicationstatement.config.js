...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/medicationstatement/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('medicationstatement'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/medicationstatement/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('medicationstatement'),
