...
const resource_specific_args = require('./messageheader.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/messageheader/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/messageheader/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/messageheader/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('messageheader'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/messageheader/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('messageheader'),
