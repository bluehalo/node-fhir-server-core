...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/NamingSystem'));
};
...
/**
 * @description Controller for updating/creating a namingsystem. If the namingsystem does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an namingsystem resource.
 */
