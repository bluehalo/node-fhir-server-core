...
const resource_specific_args = require('./operationdefinition.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/operationdefinition/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/operationdefinition/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/operationdefinition/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('operationdefinition'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/operationdefinition/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('operationdefinition'),
