...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/PaymentNotice'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let PaymentNotice = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, PaymentNotice, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: paymentnotice};
...
/**
 * @description Controller for updating/creating a paymentnotice. If the paymentnotice does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an paymentnotice resource.
 */
