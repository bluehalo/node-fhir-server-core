...
const resource_specific_args = require('./paymentreconciliation.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/paymentreconciliation/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/paymentreconciliation/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/paymentreconciliation/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('paymentreconciliation'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/paymentreconciliation/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('paymentreconciliation'),
