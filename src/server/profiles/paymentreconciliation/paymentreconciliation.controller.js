...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/PaymentReconciliation'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, PaymentReconciliation, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a paymentreconciliation. If the paymentreconciliation does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an paymentreconciliation resource.
 */
...
/**
* @description Controller for getting the history of a PaymentReconciliation resource.
*/
...
/**
* @description Controller for getting the history of a PaymentReconciliation resource by ID.
*/
