...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'PaymentReconciliation'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let PaymentReconciliation = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, req.contexts, logger)
			.then((results) =>
				responseUtils.handleSingleReadResponse(res, next, base, PaymentReconciliation, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: paymentreconciliation};
...
module.exports.history = function history ({ profile, logger, config }) {
	...
	return (req, res, next) => {
		...
		return service.history(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleBundleHistoryResponse( res, base, PaymentReconciliation, results, {
					resourceUrl: config.auth.resourceServer
				})
			)
			.catch((err) => {
