...
let getResourceConstructor = (base) => {
    return require(resolveFromVersion(base, 'base/Person'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
    ...
    return (req, res, next) => {
        ...
        return service.searchByVersionId(req.sanitized_args, logger)
            .then((results) =>
                responseUtils.handleSingleVReadResponse(res, next, base, Person, results, version_id)
            )
            .catch((err) => {
                logger.error(err);
...
/**
 * @description Controller for updating/creating a person. If the person does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an person resource.
 */
