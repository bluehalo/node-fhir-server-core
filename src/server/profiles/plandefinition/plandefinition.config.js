...
const resource_specific_args = require('./plandefinition.arguments');
const controller = require('./plandefinition.controller');

const validationUtils = require('../../utils/validation.utils');

let write_only_scopes = write_scopes('PlanDefinition');
let read_only_scopes = read_scopes('PlanDefinition');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/plandefinition/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/plandefinition/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/plandefinition/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('plandefinition'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/plandefinition/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('plandefinition'),
