...
/**
* @description Controller for getting the history of a PlanDefinition resource.
*/
module.exports.history = function history ({ profile, logger }) {
	...
	return (req, res, next) => {
		...
		let PlanDefinition = require(resolveFromVersion(version, 'uscore/PlanDefinition'));
...
/**
* @description Controller for getting the history of a PlanDefinition resource by ID.
*/
