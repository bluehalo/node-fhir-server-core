...
const resource_specific_args = require('./practitionerrole.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/practitionerrole/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/practitionerrole/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/practitionerrole/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('practitionerrole'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/practitionerrole/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('practitionerrole'),
