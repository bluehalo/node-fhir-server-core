...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/ProcessRequest'));
};
...
/**
* @description Controller for getting the history of a ProcessRequest resource.
*/
...
/**
* @description Controller for getting the history of a ProcessRequest resource by ID.
*/
