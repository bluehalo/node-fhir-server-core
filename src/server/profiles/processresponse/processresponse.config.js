...
const resource_specific_args = require('./processresponse.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/processresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/processresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/processresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('processresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/processresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('processresponse'),
