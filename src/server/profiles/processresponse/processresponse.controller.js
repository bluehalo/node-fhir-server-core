...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/ProcessResponse'));
};
...
/**
 * @description Controller for updating/creating a processresponse. If the processresponse does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an processresponse resource.
 */
...
/**
* @description Controller for getting the history of a ProcessResponse resource.
*/
...
/**
* @description Controller for getting the history of a ProcessResponse resource by ID.
*/
