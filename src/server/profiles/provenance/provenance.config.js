...
const resource_specific_args = require('./provenance.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/provenance/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/provenance/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('provenance'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/provenance/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('provenance'),
