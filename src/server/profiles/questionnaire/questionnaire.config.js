...
const resource_specific_args = require('./questionnaire.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/questionnaire/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/questionnaire/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/questionnaire/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('questionnaire'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/questionnaire/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('questionnaire'),
