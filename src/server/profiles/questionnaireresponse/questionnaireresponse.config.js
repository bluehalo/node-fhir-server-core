...
const resource_specific_args = require('./questionnaireresponse.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/questionnaireresponse/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/questionnaireresponse/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/questionnaireresponse/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('questionnaireresponse'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/questionnaireresponse/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('questionnaireresponse'),
