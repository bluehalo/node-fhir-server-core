...
module.exports.getQuestionnaireResponse = (req, logger, context) => new Promise((resolve, reject) => {
	let message = 'Calling mock service. Did you forget to implement \'getQuestionnaireResponse\'';
	logger.info(message);
	reject(new Error(message));
});

module.exports.getQuestionnaireResponseById = (req, logger, context) => new Promise((resolve, reject) => {
