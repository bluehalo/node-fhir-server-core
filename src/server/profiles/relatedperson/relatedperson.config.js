...
const resource_specific_args = require('./relatedperson.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/relatedperson/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/relatedperson/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/relatedperson/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('relatedperson'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/relatedperson/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('relatedperson'),
