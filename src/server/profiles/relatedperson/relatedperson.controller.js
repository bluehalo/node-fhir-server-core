...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/RelatedPerson'));
};
...
/**
* @description Controller for getting the history of a RelatedPerson resource.
*/
...
/**
* @description Controller for getting the history of a RelatedPerson resource by ID.
*/
