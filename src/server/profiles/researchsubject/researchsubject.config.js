...
const resource_specific_args = require('./researchsubject.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/researchsubject/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/researchsubject/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/researchsubject/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('researchsubject'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/researchsubject/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('researchsubject'),
