...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/ResearchSubject'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let ResearchSubject = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, ResearchSubject, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let args = {id: resource_id, resource: researchsubject};
...
/**
 * @description Controller for updating/creating a researchsubject. If the researchsubject does not exist, it should be updated
 */
module.exports.update = function update({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		// Create a new researchsubject resource and pass it to the service
		let researchsubject = new ResearchSubject(resource_body);
		let args = {id, resource: researchsubject};
		// Pass any new information to the underlying service
...
/**
 * @description Controller for deleting an researchsubject resource.
 */
...
/**
* @description Controller for getting the history of a ResearchSubject resource.
*/
...
/**
* @description Controller for getting the history of a ResearchSubject resource by ID.
*/
