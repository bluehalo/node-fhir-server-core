...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Sequence'));
};
...
/**
 * @description Controller for updating/creating a sequence. If the sequence does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an sequence resource.
 */
...
/**
* @description Controller for getting the history of a Sequence resource.
*/
...
/**
* @description Controller for getting the history of a Sequence resource by ID.
*/
