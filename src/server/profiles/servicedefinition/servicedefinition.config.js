...
const resource_specific_args = require('./servicedefinition.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/servicedefinition/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/servicedefinition/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/servicedefinition/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('servicedefinition'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/servicedefinition/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('servicedefinition'),
