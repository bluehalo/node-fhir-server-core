...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/ServiceDefinition'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, ServiceDefinition, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a servicedefinition. If the servicedefinition does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an servicedefinition resource.
 */
