...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/specimen/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('specimen'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/specimen/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('specimen'),
