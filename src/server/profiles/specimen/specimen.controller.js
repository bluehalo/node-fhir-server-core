...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/Specimen'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		let Specimen = getResourceConstructor(base);

		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, Specimen, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a specimen. If the specimen does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an specimen resource.
 */
...
/**
* @description Controller for getting the history of a Specimen resource.
*/
...
/**
* @description Controller for getting the history of a Specimen resource by ID.
*/
