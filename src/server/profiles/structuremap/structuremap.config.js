...
const resource_specific_args = require('./structuremap.arguments');
const controller = require('./structuremap.controller');

const validationUtils = require('../../utils/validation.utils');

let write_only_scopes = write_scopes('StructureMap');
let read_only_scopes = read_scopes('StructureMap');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/structuremap/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/structuremap/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/structuremap/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('structuremap'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/structuremap/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('structuremap'),
