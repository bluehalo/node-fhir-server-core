...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/StructureMap'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, StructureMap, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
* @description Controller for getting the history of a StructureMap resource.
*/
...
/**
* @description Controller for getting the history of a StructureMap resource by ID.
*/
