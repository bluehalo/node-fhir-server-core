...
const resource_specific_args = require('./subscription.arguments');
...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/subscription/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/subscription/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/subscription/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('subscription'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/subscription/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('subscription'),
