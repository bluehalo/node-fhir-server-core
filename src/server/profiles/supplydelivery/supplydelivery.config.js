...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/supplydelivery/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'get',
		path: '/:base/supplydelivery/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/supplydelivery/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('supplydelivery'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/supplydelivery/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('supplydelivery'),
