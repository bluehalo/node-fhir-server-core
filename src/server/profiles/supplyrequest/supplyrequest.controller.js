...
/**
* @description Controller for getting the history of a SupplyRequest resource.
*/
module.exports.history = function history ({ profile, logger }) {
	...
	return (req, res, next) => {
		...
		let SupplyRequest = require(resolveFromVersion(version, 'uscore/SupplyRequest'));
...
/**
* @description Controller for getting the history of a SupplyRequest resource by ID.
*/
