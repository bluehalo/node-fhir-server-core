...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/testreport/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/testreport/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('testreport'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/testreport/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('testreport'),
