...
let routes = [
	...
	{
		type: 'get',
		path: '/:base/testscript/:id/_history',
		args: resource_all_arguments,
		scopes: read_only_scopes,
	...
	{
		type: 'post',
		path: '/:base/testscript/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('testscript'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/testscript/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('testscript'),
