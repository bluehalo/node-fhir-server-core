...
let getResourceConstructor = (base) => {
    return require(resolveFromVersion(base, 'base/TestScript'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
    ...
    return (req, res, next) => {
        ...
        let TestScript = getResourceConstructor(base);

        return service.searchByVersionId(req.sanitized_args, logger)
            .then((results) =>
                responseUtils.handleSingleVReadResponse(res, next, base, TestScript, results, version_id)
            )
            .catch((err) => {
                logger.error(err);
...
module.exports.create = function create({profile, logger, app}) {
    ...
    return (req, res, next) => {
        ...
        let args = {id: resource_id, resource: testscript};
...
/**
 * @description Controller for updating/creating a testscript. If the testscript does not exist, it should be updated
 */
module.exports.update = function update({profile, logger, app}) {
    ...
    return (req, res, next) => {
        ...
        // Create a new testscript resource and pass it to the service
        let testscript = new TestScript(resource_body);
        let args = {id, resource: testscript};
        // Pass any new information to the underlying service
...
/**
 * @description Controller for deleting an testscript resource.
 */
