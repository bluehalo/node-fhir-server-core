...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/valueset/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('valueset'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/valueset/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('valueset'),
