...
let routes = [
	...
	{
		type: 'post',
		path: '/:base/visionprescription/([\$])validate',
		args: [
			route_args.BASE
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModel('visionprescription'),
		dependencies: []
	},
	{
		type: 'post',
		path: '/:base/visionprescription/:id/([\$])validate',
		args: [
			route_args.BASE,
			route_args.ID
		],
		scopes: read_only_scopes,
		controller: validationUtils.validateModelById('visionprescription'),
