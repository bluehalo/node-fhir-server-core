...
let getResourceConstructor = (base) => {
	return require(resolveFromVersion(base, 'base/VisionPrescription'));
};
...
module.exports.searchByVersionId = function searchByVersionId({profile, logger, app}) {
	...
	return (req, res, next) => {
		...
		return service.searchByVersionId(req.sanitized_args, logger)
			.then((results) =>
				responseUtils.handleSingleVReadResponse(res, next, base, VisionPrescription, results, version_id)
			)
			.catch((err) => {
				logger.error(err);
...
/**
 * @description Controller for updating/creating a visionprescription. If the visionprescription does not exist, it should be updated
 */
...
/**
 * @description Controller for deleting an visionprescription resource.
 */
