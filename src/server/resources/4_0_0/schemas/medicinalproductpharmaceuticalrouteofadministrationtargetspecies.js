		...
		Object.defineProperty(this, 'withdrawalPeriod', {
			...
			set: value => {
				...
				this.__data.withdrawalPeriod = Array.isArray(value)
					? value.map(v => new MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod(v))
					: [new MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod(value)];
			},
		});
