...
class ClaimResponse extends DomainResource {
	...
	set note (new_value) {
		...
		this.__note = Array.isArray(new_value) ? new_value.map(val => new ClaimResponseNote(val)) : [new ClaimResponseNote(new_value)];
	}
	...
	set coverage (new_value) {
		...
		this.__coverage = Array.isArray(new_value) ? new_value.map(val => new ClaimResponseCoverage(val)) : [new ClaimResponseCoverage(new_value)];
	}
