...
class ClaimResponseAddItemDetail extends BackboneElement {
	...
	set adjudication (new_value) {
		...
		this.__adjudication = Array.isArray(new_value) ? new_value.map(val => new ClaimResponseAddItemDetailAdjudication(val)) : [new ClaimResponseAddItemDetailAdjudication(new_value)];
	}
