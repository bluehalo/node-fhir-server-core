...
class ClaimResponseItemDetail extends BackboneElement {
	...
	set adjudication (new_value) {
		...
		this.__adjudication = Array.isArray(new_value) ? new_value.map(val => new ClaimResponseItemDetailAdjudication(val)) : [new ClaimResponseItemDetailAdjudication(new_value)];
	}
