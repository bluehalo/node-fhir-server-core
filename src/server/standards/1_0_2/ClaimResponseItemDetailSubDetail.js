...
class ClaimResponseItemDetailSubDetail extends BackboneElement {
	...
	set adjudication (new_value) {
		...
		this.__adjudication = Array.isArray(new_value) ? new_value.map(val => new ClaimResponseItemDetailSubDetailAdjudication(val)) : [new ClaimResponseItemDetailSubDetailAdjudication(new_value)];
	}
