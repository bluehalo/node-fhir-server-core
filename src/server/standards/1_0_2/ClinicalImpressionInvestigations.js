...
class ClinicalImpressionInvestigations extends BackboneElement {
	constructor(opt) {
		super(opt);
		this.__resourceType = 'ClinicalImpressionInvestigations';
		Object.assign(this, opt);
	}

	// This is a ClinicalImpressionInvestigations resource
