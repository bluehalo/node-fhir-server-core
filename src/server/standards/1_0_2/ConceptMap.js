...
class ConceptMap extends DomainResource {
	...
	set contact (new_value) {
		...
		this.__contact = Array.isArray(new_value) ? new_value.map(val => new ConceptMapContact(val)) : [new ConceptMapContact(new_value)];
	}
	...
	set useContext (new_value) {
		...
		this.__useContext = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set element (new_value) {
		...
		this.__element = Array.isArray(new_value) ? new_value.map(val => new ConceptMapElement(val)) : [new ConceptMapElement(new_value)];
	}
