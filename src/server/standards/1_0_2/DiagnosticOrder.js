...
class DiagnosticOrder extends DomainResource {
	...
	set event (new_value) {
		...
		this.__event = Array.isArray(new_value) ? new_value.map(val => new DiagnosticOrderEvent(val)) : [new DiagnosticOrderEvent(new_value)];
	}
	...
	set item (new_value) {
		...
		this.__item = Array.isArray(new_value) ? new_value.map(val => new DiagnosticOrderItem(val)) : [new DiagnosticOrderItem(new_value)];
	}
