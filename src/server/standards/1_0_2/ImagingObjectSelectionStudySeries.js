...
class ImagingObjectSelectionStudySeries extends BackboneElement {
	...
	set instance (new_value) {
		...
		this.__instance = Array.isArray(new_value) ? new_value.map(val => new ImagingObjectSelectionStudySeriesInstance(val)) : [new ImagingObjectSelectionStudySeriesInstance(new_value)];
	}
