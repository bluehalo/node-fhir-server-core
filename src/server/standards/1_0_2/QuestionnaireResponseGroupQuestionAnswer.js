...
class QuestionnaireResponseGroupQuestionAnswer extends BackboneElement {
	constructor(opt) {
		super(opt);
		this.__resourceType = 'QuestionnaireResponseGroupQuestionAnswer';
		Object.assign(this, opt);
	}

	// This is a QuestionnaireResponseGroupQuestionAnswer resource
...
module.exports = QuestionnaireResponseGroupQuestionAnswer;
