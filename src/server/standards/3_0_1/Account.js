...
class Account extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			active: this._active && this._active.toJSON(),
			balance: this._balance && this._balance.toJSON(),
			coverage: this._coverage && this._coverage.map(v => v.toJSON()),
			owner: this._owner && this._owner.toJSON(),
			description: this._description,
			guarantor: this._guarantor && this._guarantor.map(v => v.toJSON())
		});
	}
