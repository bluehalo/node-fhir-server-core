...
class AdverseEvent_SuspectEntity extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			instance: this._instance && this._instance.toJSON(),
			causality: this._causality,
			causalityAssessment: this._causalityAssessment && this._causalityAssessment.toJSON(),
			causalityProductRelatedness: this._causalityProductRelatedness,
			causalityMethod: this._causalityMethod && this._causalityMethod.toJSON(),
			causalityAuthor: this._causalityAuthor && this._causalityAuthor.toJSON(),
			causalityResult: this._causalityResult && this._causalityResult.toJSON()
		});
	}
