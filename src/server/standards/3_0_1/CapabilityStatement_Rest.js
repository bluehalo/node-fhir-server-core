...
class CapabilityStatement_Rest extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			security: this._security && this._security.toJSON(),
			resource: this._resource && this._resource.map(v => v.toJSON()),
			interaction: this._interaction && this._interaction.map(v => v.toJSON()),
			searchParam: this._searchParam && this._searchParam.map(v => v.toJSON()),
			operation: this._operation && this._operation.map(v => v.toJSON()),
