...
class ChargeItem extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			performingOrganization: this._performingOrganization && this._performingOrganization.toJSON(),
			requestingOrganization: this._requestingOrganization && this._requestingOrganization.toJSON(),
			...
			priceOverride: this._priceOverride && this._priceOverride.toJSON(),
			...
			service: this._service && this._service.map(v => v.toJSON()),
