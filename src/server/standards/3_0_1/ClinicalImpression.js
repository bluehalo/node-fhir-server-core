...
class ClinicalImpression extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			date: this._date,
			assessor: this._assessor && this._assessor.toJSON(),
			previous: this._previous && this._previous.toJSON(),
			problem: this._problem && this._problem.map(v => v.toJSON()),
			investigation: this._investigation && this._investigation.map(v => v.toJSON()),
			protocol: this._protocol,
			summary: this._summary,
			finding: this._finding && this._finding.map(v => v.toJSON()),
			prognosisCodeableConcept: this._prognosisCodeableConcept && this._prognosisCodeableConcept.map(v => v.toJSON()),
			prognosisReference: this._prognosisReference && this._prognosisReference.map(v => v.toJSON()),
