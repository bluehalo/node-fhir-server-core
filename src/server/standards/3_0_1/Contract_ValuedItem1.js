...
class Contract_ValuedItem1 extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			entityCodeableConcept: this._entityCodeableConcept && this._entityCodeableConcept.toJSON(),
			entityReference: this._entityReference && this._entityReference.toJSON(),
