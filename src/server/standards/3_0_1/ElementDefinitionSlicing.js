...
class ElementDefinitionSlicing extends Element {
	...
	set discriminator(new_value) {
		...
		this.__discriminator = Array.isArray(new_value)
			? new_value.map(val => new ElementDefinitionSlicingDiscriminator(val))
			: [new ElementDefinitionSlicingDiscriminator(new_value)];
	}
