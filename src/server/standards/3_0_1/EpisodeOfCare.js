...
class EpisodeOfCare extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			referralRequest: this._referralRequest && this._referralRequest.map(v => v.toJSON()),
			careManager: this._careManager && this._careManager.toJSON(),
			team: this._team && this._team.map(v => v.toJSON()),
