...
class ExplanationOfBenefit extends DomainResource {
	...
	set related(new_value) {
		...
		this.__related = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitRelated(val))
			: [new ExplanationOfBenefitRelated(new_value)];
	}
	...
	set information(new_value) {
		...
		this.__information = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitInformation(val))
			: [new ExplanationOfBenefitInformation(new_value)];
	}
	...
	set careTeam(new_value) {
		...
		this.__careTeam = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitCareTeam(val))
			: [new ExplanationOfBenefitCareTeam(new_value)];
	}
	...
	set diagnosis(new_value) {
		...
		this.__diagnosis = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitDiagnosis(val))
			: [new ExplanationOfBenefitDiagnosis(new_value)];
	}
	...
	set procedure(new_value) {
		...
		this.__procedure = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitProcedure(val))
			: [new ExplanationOfBenefitProcedure(new_value)];
	}
	...
	set item(new_value) {
		...
		this.__item = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitItem(val))
			: [new ExplanationOfBenefitItem(new_value)];
	}
	...
	set addItem(new_value) {
		...
		this.__addItem = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitAddItem(val))
			: [new ExplanationOfBenefitAddItem(new_value)];
	}
	...
	set processNote(new_value) {
		...
		this.__processNote = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitProcessNote(val))
			: [new ExplanationOfBenefitProcessNote(new_value)];
	}
	...
	set benefitBalance(new_value) {
		...
		this.__benefitBalance = Array.isArray(new_value)
			? new_value.map(val => new ExplanationOfBenefitBenefitBalance(val))
			: [new ExplanationOfBenefitBenefitBalance(new_value)];
	}
