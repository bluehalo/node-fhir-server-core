...
class ExplanationOfBenefit_Diagnosis extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			diagnosisCodeableConcept: this._diagnosisCodeableConcept && this._diagnosisCodeableConcept.toJSON(),
			diagnosisReference: this._diagnosisReference && this._diagnosisReference.toJSON(),
			type: this._type && this._type.map(v => v.toJSON()),
			packageCode: this._packageCode && this._packageCode.toJSON()
		});
	}

}

module.exports = ExplanationOfBenefit_Diagnosis;
