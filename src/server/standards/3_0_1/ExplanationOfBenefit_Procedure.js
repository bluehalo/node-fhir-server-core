...
class ExplanationOfBenefit_Procedure extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			date: this._date,
			procedureCodeableConcept: this._procedureCodeableConcept && this._procedureCodeableConcept.toJSON(),
			procedureReference: this._procedureReference && this._procedureReference.toJSON()
		});
	}

}

module.exports = ExplanationOfBenefit_Procedure;
