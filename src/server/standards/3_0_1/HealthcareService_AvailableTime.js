...
class HealthcareService_AvailableTime extends BackboneElement {
	...
	set daysOfWeek ( new_value ) {
		...
		let allowed_values = ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'];
		if ( new_value && allowed_values.indexOf(new_value) === -1 ) {
			throw new Error(`Expected one of ${allowed_values}, got ${new_value} for field daysOfWeek`);
		}
