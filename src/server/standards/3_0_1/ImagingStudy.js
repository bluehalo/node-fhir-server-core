...
class ImagingStudy extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			uid: this._uid,
			accession: this._accession && this._accession.toJSON(),
			identifier: this._identifier && this._identifier.map(v => v.toJSON()),
			availability: this._availability,
			modalityList: this._modalityList && this._modalityList.map(v => v.toJSON()),
			...
			referrer: this._referrer && this._referrer.toJSON(),
			interpreter: this._interpreter && this._interpreter.map(v => v.toJSON()),
			...
			procedureReference: this._procedureReference && this._procedureReference.map(v => v.toJSON()),
			procedureCode: this._procedureCode && this._procedureCode.map(v => v.toJSON()),
			reason: this._reason && this._reason.toJSON(),
			description: this._description,
			series: this._series && this._series.map(v => v.toJSON())
		});
	}
