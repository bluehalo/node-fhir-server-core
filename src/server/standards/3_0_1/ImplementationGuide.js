...
class ImplementationGuide extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			dependency: this._dependency && this._dependency.map(v => v.toJSON()),
			package: this._package && this._package.map(v => v.toJSON()),
			global: this._global && this._global.map(v => v.toJSON()),
			binary: this._binary,
			page: this._page && this._page.toJSON()
		});
	}
