...
class MedicationDispense extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			authorizingPrescription: this._authorizingPrescription && this._authorizingPrescription.map(v => v.toJSON()),
			type: this._type && this._type.toJSON(),
			quantity: this._quantity && this._quantity.toJSON(),
			daysSupply: this._daysSupply && this._daysSupply.toJSON(),
			...
			notDoneReasonCodeableConcept: this._notDoneReasonCodeableConcept && this._notDoneReasonCodeableConcept.toJSON(),
			notDoneReasonReference: this._notDoneReasonReference && this._notDoneReasonReference.toJSON(),
