...
class Questionnaire_EnableWhen extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			answerAttachment: this._answerAttachment && this._answerAttachment.toJSON(),
			answerCoding: this._answerCoding && this._answerCoding.toJSON(),
			answerQuantity: this._answerQuantity && this._answerQuantity.toJSON(),
			answerReference: this._answerReference && this._answerReference.toJSON()
		});
	}
