...
class Questionnaire_Item extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			text: this._text,
			type: this._type,
			enableWhen: this._enableWhen && this._enableWhen.map(v => v.toJSON()),
			required: this._required,
			repeats: this._repeats,
			readOnly: this._readOnly,
			maxLength: this._maxLength,
			options: this._options && this._options.toJSON(),
			option: this._option && this._option.map(v => v.toJSON()),
			...
			initialAttachment: this._initialAttachment && this._initialAttachment.toJSON(),
			initialCoding: this._initialCoding && this._initialCoding.toJSON(),
			initialQuantity: this._initialQuantity && this._initialQuantity.toJSON(),
			initialReference: this._initialReference && this._initialReference.toJSON(),
