...
class Sequence_ReferenceSeq extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			chromosome: this._chromosome && this._chromosome.toJSON(),
			genomeBuild: this._genomeBuild,
			referenceSeqId: this._referenceSeqId && this._referenceSeqId.toJSON(),
			referenceSeqPointer: this._referenceSeqPointer && this._referenceSeqPointer.toJSON(),
