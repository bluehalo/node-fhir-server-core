...
class Specimen_Processing extends BackboneElement {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			procedure: this._procedure && this._procedure.toJSON(),
			additive: this._additive && this._additive.map(v => v.toJSON()),
			timeDateTime: this._timeDateTime,
			timePeriod: this._timePeriod && this._timePeriod.toJSON()
		});
	}
