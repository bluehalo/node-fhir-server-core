...
class TestScript_Rule3 extends BackboneElement {
	...
	set param ( new_value ) {
		this._param = Array.isArray(new_value) ? new_value.map(val => new TestScript_Param3(val)) : [new TestScript_Param3(new_value)];
	}
...
module.exports = TestScript_Rule3;
