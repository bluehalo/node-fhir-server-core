...
class Patient extends DomainResource {
	...
	toJSON () {
		return Object.assign(super.toJSON(), {
			...
			photo: this.photo.map(v => v.toJSON()),
			contact: this.contact.map(v => v.toJSON()),
			animal: this.animal && this.animal.toJSON(),
			communication: this.communication.map(v => v.toJSON()),
			generalPractitioner: this.generalPractitioner.map(v => v.toJSON()),
